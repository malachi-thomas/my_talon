...
cursor north: user.vscode("editor.action.insertCursorAbove")
cursor south: user.vscode("editor.action.insertCursorBelow")
...
split east: user.vscode("workbench.action.splitEditor`")
split south: user.vscode("workbench.action.splitEditorDown")
split west: user.vscode("workbench.action.splitEditorLeft")
split right: user.vscode("workbench.action.splitEditorUp")

line north: user.vscode("editor.action.moveLinesUpAction")
line south: user.vscode("editor.action.moveLinesDownAction")
